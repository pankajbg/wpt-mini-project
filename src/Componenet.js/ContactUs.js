...
{
    let [contact, setContact]=useState({fname:"", lname:"", mobile:"", email:"", msg:""});
        ...
        <>
            <form>
                <div className="container-fluid">
                    <div
                        className="row bg-primary-subtle align-text-center justify-content-center"
                    >
            ...
            <div className="container-fluid">
                ...
                >
                    ...
                    <hr className="text-light" />
                    <ul>
                        <li><span>&#9993; </span> bhagatp@gmail.com</li>
                        <li><span>&#128241;</span>8161228205</li>
                        <li>Shivaji Colony, Panchadhara Road,</li>
                        <li>Pulgaon- 442302</li>
                    </ul>
                    </div>
                    ...
                    <hr className="text-light" />
                    <ul>
                        <li><span>&#9993;</span> vtambe@gmail.com</li>
                        <li><span>&#128241; </span>8581767425</li>
                        <li>Shivaji Colony, Panchadhara Road,</li>
                        <li>Latur - 442302</li>
                    </ul>
                    </div>
