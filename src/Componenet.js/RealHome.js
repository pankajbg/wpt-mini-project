    ...
    return(
        ...
        <div className="container-fluid">
            <div className="pt-1 bg-warning-subtle w-">
                <marquee>
                    <h5>*** पंचायती राज का है योगदान, गाँव गाँव में चला विकास अभियान पंचायती राज ने बदली काया, गाँव गलियारों में विकास कराया ***</h5>
                </marquee>
            </div>
            ...
            <div className="col-sm-12 col-md-10">
                ...
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                    <img src="home1.png" className="d-block w-100" style={{height: "75vh"}} />
                    </div>
                    <div className="carousel-item">
                    <img
                        src="Home3.jfif"
                ...
                <div className="col-sm-12 col-md-12">
                    ...
                    <div className="col-sm-6 col-md-4">
                        <Card style={{ width: '16rem' }}>
                            <Card.Img variant="top" src="HomeSuggestion.png" className="card-img-top imgCard" />
                            <Card.Body>
                                <Card.Title>Suggestion Box</Card.Title>
                                <Button variant="primary" onClick={goToSugg}>Click Here</Button>
                            </Card.Body>
                        </Card>
                    </div>
                    <div className="col-sm-6 col-md-4">
                        <Card style={{ width: '16rem' }}>
                            <Card.Img variant="top" src="HomeGramSabha.jfif" className="card-img-top imgCard" />
                            <Card.Body>
                                <Card.Title>Gram Sabha Info</Card.Title>
                                <Button variant="primary" onClick={goToMeetingInfo}>Click Here</Button>
                            </Card.Body>
                        </Card>
                    </div>
                    <div className="col-sm-6 col-md-4">
                        <Card style={{ width: '16rem' }}>
                            <Card.Img variant="top" src="HomeDonation.png" className="card-img-top imgCard"/>
                            <Card.Body>
                                <Card.Title>Donation Box</Card.Title>
                                <Button variant="primary" onClick={goToDonation}>Click Here</Button>
                            </Card.Body>
                        </Card>
                    </div>
                    <div className="col-sm-6 col-md-4">
                        <Card style={{ width: '16rem' }}>
                            <Card.Img variant="top" src="HomeFund.jfif" className="card-img-top imgCard" />
                            <Card.Body>
                    ...
                    <div className="col-sm-6 col-md-4">
                        <Card style={{ width: '16rem' }}>
                            <Card.Img variant="top" src="HomeTax.jfif" className="card-img-top imgCard" />
                            <Card.Body>
                                <Card.Title>Property Tax</Card.Title>
                                <Button variant="primary" onClick={goToTax}>Click Here</Button>
                            </Card.Body>
                        </Card>
                    </div>
                    <div className="col-sm-6 col-md-4">
                        <Card style={{ width: '16rem' }}>
                            <Card.Img variant="top" src="HomeWater.jfif" className="card-img-top imgCard" />
                            <Card.Body>
                                <Card.Title>Water Bill</Card.Title>
                                <Button variant="primary" onClick={goToWaterBill}>Click Here</Button>
                            </Card.Body>
                        </Card>
                    </div>
                    </div>
